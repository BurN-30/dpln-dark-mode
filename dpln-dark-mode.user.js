...
(function() {
    ...
    if (isDark) {
        document.documentElement.style.setProperty('background', '#1a1b20', 'important');
        document.documentElement.style.setProperty('color', '#d1cdc7', 'important');
    }
    ...
    const css = `
        ...
        body.dpln-dark a b,
        body.dpln-dark font[color] strong,
        body.dpln-dark font[color] b {
        ...
        body.dpln-dark .fast-travel-coord:hover {
        ...
        body.dpln-dark .secondTitle {
            background: var(--bg-sec) none !important;
            padding: 6px 12px !important;
            border-radius: 4px !important;
        }

        body.dpln-dark .dungeon-last-update {
            background: var(--bg-sec) none !important;
            border-radius: 4px !important;
